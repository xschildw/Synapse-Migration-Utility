...
public class AsyncMigrationTypeCountsWorker implements Callable<MigrationTypeCounts> {
    ...
    public AsyncMigrationTypeCountsWorker(SynapseAdminClientImpl client, List<MigrationType> migrationTypes, long timeoutMS, BasicProgress progress) {
        this.client = client;
    ...
    public MigrationTypeCounts call() throws Exception {
        ...
        AsyncMigrationWorker worker = new AsyncMigrationWorker(this.client, req, this.timeoutMS, this.progress);
